...
TEST(PointCloudVoxelsGPU, TestBarelyCollision) {
    ...
    // essentially 2.1
    auto v2_left = roadmap->addVertex("v2_left", std::make_shared<DroneState>(Point(0, 0, -0.2), ROBOT_RADIUS));
...
TEST(PointCloudVoxelsGPU, TestNoCollision) {
    ...
    // start_point 1: (-10.000000, 0.000000, 0.000000)
    // end_point 1: (-5.000000, 5.000000, 0.000000)
    // start_point 2: (10.000000, 0.000000, 0.000000)
    // end_point 2: (0.000000, 0.000000, 0.000000)
    ...
    // essentially 2.1
    auto v2_left =
        roadmap->addVertex("v2_left", std::make_shared<DroneState>(Point(10.000000, 0.000000, 0.000000), ROBOT_RADIUS));
    auto v2_right =
...
TEST(PointCloudVoxelsGPU, TestCollisionCommonPosition) {
    ...
    // start_point: (-10.000000, 0.000000, 0.000000)
    // end_point: (-5.000000, 5.000000, 0.000000)
    // start_point: (-5.000000, 5.000000, 0.000000)
    // end_point: (0.000000, 10.000000, 0.000000)
    ...
    // essentially 2.1
    auto v2_left =
        roadmap->addVertex("v2_left", std::make_shared<DroneState>(Point(-5.000000, 5.000000, 0.000000), ROBOT_RADIUS));
    auto v2_right =
        roadmap->addVertex("v2_right", std::make_shared<DroneState>(Point(0.000000, 0.000000, 0.000000), ROBOT_RADIUS));
...
TEST(PointCloudVoxelsGPU, TestNoCollisionAnother) {
    //
    // Checks that two voxels that barely intersect each other actually intersect
    //
    const float ROBOT_RADIUS = 1.0;

    //     start_point 1: (0.000000, 10.000000, 0.000000)
    // end_point 1: (5.000000, 5.000000, 0.000000)
    // start_point 2: (-10.000000, 0.000000, 0.000000)
    // end_point 2: (0.000000, 0.000000, 0.000000)
...
TEST(PointCloudVoxelsGPU, TestNoCollisionAnotherHaha) {
    //
    // Checks that two voxels that barely intersect each other actually intersect
    //
    const float ROBOT_RADIUS = 1.0;

    //     start_point 1: (5.000000, 5.000000, 0.000000)
    // end_point 1: (10.000000, 0.000000, 0.000000)
    // start_point 2: (0.000000, 0.000000, 0.000000)
    // end_point 2: (10.000000, 0.000000, 0.000000)
...
TEST(PointCloudVoxelsGPU, TestNoCollisionAnotherHahaWow) {
    //
    // Checks that two voxels that barely intersect each other actually intersect
    //
    const float ROBOT_RADIUS = 1.0;
