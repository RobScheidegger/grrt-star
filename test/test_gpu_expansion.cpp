...
TEST(SolverExpansionGPU, TestGPURRTExpansion1) {
    //
    ...
    config->robots.push_back(std::make_shared<DroneGPU>(1, "Drone 1", roadmap));
    config->robots.push_back(std::make_shared<DroneGPU>(2, "Drone 2", roadmap));
